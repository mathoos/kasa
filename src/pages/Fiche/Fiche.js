			...
			<div className='container'>
				...
				<div className="logement">
					...
					<div className="logement_bloc">  
						<div className="logement_bloc-content">
							<div className="logement_bloc-content--title">
								<h1 className="titre-principal">{logement.title}</h1>
								<p className="titre-secondaire">{logement.location}</p>
								
							</div>
							<div className="logement_bloc-content--tag">
						...
						<div className="logement_bloc-content">
							<div className="logement_bloc-content--host">
								<p className="host-name">{logement.host.name}</p>
								<img src={logement.host.picture} alt={logement.host.name} className="host-img"/>
							</div>
							<div className="logement_bloc-content--rating">
								{starArray.map(( i) => (
